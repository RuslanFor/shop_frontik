...
import { $boilerParts, setBoilerParts, $boilerManufacturers, $partsManufacturers, updateBoilerManufacturer, updatePartsManufacturer, setBoilerManufacturers, setPartsManufacturers, $filteredBoilerParts } from '@/context/boilerParts';
...
const CatalogPage = ({query}:{query:IQueryParams}) => {
    ...
    const isAnyBoilerManufacturerCheked = boilerManufacturers.some((item) => item.checked)
    const isAnyPartsManufacturerCheked = partsManufacturers.some((item) => item.checked)

    const resetFilterBtnDisabled = !(ispriceRangeChanged || isAnyBoilerManufacturerCheked || isAnyPartsManufacturerCheked)
    useEffect(() => {
        loadBoilerParts()
        ...
        <section className={styles.catalog}>
            <div className={`container ${styles.catalog__container}`}>
                ...
                <div className={`${styles.catalog__top} ${darkModeClass}`}>
                    <AnimatePresence>
                        {isAnyBoilerManufacturerCheked && <ManufacturersBlock
                            title='Производитель'
                    ...
                    <AnimatePresence>
                        {isAnyPartsManufacturerCheked && <ManufacturersBlock 
                            title='Бренд' 
