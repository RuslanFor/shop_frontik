                ...
                <div className={styles.footer__top}>
                    ...
                    <div className={styles.footer__top__inner}>
                        <div className={styles.footer__top__item}>
                            {!isMedia500 && <><h3 className={styles.footer__top__item__title}>Интернет магазин</h3>
                            <OnlineStoreContent/></>}
                            {isMedia500 && (<Accordion title='Интернет магазин' titleClass={styles.footer__top__item__title} arrowOpenClass={styles.open}>
                                <OnlineStoreContent/><div style={{height: 17}}></div></Accordion>)}
                        </div>
                        <div className={styles.footer__top__item}>
                        {!isMedia500 && <><h3 className={styles.footer__top__item__title}>Компания</h3>
                            <CompanyContent/></>}
                        {isMedia500 && (<Accordion title='Компания' titleClass={styles.footer__top__item__title} arrowOpenClass={styles.open}>
                                <CompanyContent/><div style={{height: 17}}></div></Accordion>)}
                        </div>
                    </div>
                    <div className={styles.footer__top__item}>
                            ...
                            <ul className={`${styles.footer__top__item__list} ${styles.footer__top__item__contacts}`}>
                                ...
                                <li className={styles.footer__top__item__list__item}>
                                        <a href='tel:+712812929' className={styles.footer__top__item__list__item__link}>
                                ...
                                <li className={styles.footer__top__item__list__item}>
                                        <a href='mailto:info@gmail.ru' className={styles.footer__top__item__list__item__link}>
                                            <span>E-mail:</span>
                                            <span>info@gmail.ru</span>
                                            <span>
                                                <MailSvg/>
                                            </span>
                                        </a>
                ...
                <div className={styles.footer__bottom}>
                    <div className={styles.footer__bottom__block}>
                        <div className={styles.footer__bottom__block__left}>
                            <h3 className={styles.footer__bottom__block__title}>Мы принимаем оплату:</h3>
